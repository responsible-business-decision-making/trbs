...
class ReportExporter:
    ...
    def make_subtitle(self, slide) -> None:
        """
    ...
    def iter_cells(self, table) -> None:
        """
    ...
    def make_table_2_col(self, slide, col_left, col_right, col_left_header, col_right_header, first_element=0,
        ...
        self.change_format_cells(table, 12)
    ...
    def change_format_cells(self, table, format_size) -> None:
        """
    ...
    def make_slides(self, scenario) -> Presentation():
        ...
        self.make_subtitle(slide_title)
